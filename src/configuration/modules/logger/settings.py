...
def get_configuration(
    ...
    Args:
        ...
        debug_console_level (str, optional): Defaults to 'DEBUG'.
        debug_file_level (str, optional): Defaults to 'DEBUG'.
        debug_file_location (str, optional): Defaults to None.
        error_file_level (str, optional): Defaults to 'ERROR'.
        error_file_location (str, optional): Defaults to None.

    Returns:
        dict: logger config dict
    Author:
        name: muktevigk
    Version:
        version: v1
